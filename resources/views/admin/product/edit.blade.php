                ...
                <div class="col-6">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="brand" id="brand" aria-label="Default select example">
                            ...
                            <option value="Adidas" @selected($product->brand == 'Adidas')>Adidas</option>
                            <option value="Nike" @selected($product->brand == 'Nike')>Nike</option>
                            <option value="Puma" @selected($product->brand == 'Puma')>Puma</option>
                        </select>
