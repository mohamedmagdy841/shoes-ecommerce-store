...
{{--            Home--}}
            <li class="nav-item">
                <a class="nav-link  @yield('home active')" href="{{ route('admin.dashboard') }}">
...
{{--            Users--}}
            ...
            {{--            Categories--}}
            <li class="nav-item">
                <a class="nav-link  @yield('category active')" href="{{ route('admin.categories.index') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
...
{{--            Products--}}
            <li class="nav-item">
                <a class="nav-link  @yield('product active')" href="{{ route('admin.products.index') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 43 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
...
{{--            Coupons--}}
            <li class="nav-item">
                <a class="nav-link  @yield('coupon active')" href="{{ route('admin.coupons.index') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 43 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <g transform="translate(-2169.000000, -745.000000)" fill="#FFFFFF" fill-rule="nonzero">
                    ...
                    <span class="nav-link-text @if (LaravelLocalization::getCurrentLocale() == 'ar') me-1 @else ms-1 @endif">{{ __('keywords.manage') }} {{ __('keywords.coupons') }}</span>
                </a>
            </li>
{{--            Orders--}}
            <li class="nav-item">
...
{{--            Settings--}}
            <li class="nav-item">
                <a class="nav-link  @yield('setting active')" href="{{ route('admin.settings.index') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
...
{{--            Roles & Admins--}}
            @if(auth('admin')->user()->hasRole('Super Admin'))
                ...
                <li class="nav-item">
                    <a class="nav-link  @yield('role active')" href="{{ route('admin.roles.index') }}">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
