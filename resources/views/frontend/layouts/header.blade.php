            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                    <ul class="nav navbar-nav menu_nav ml-auto">
                        <li class="nav-item @yield('home-active')"><a class="nav-link" href="index.html">Home</a></li>
                        ...
                        <li class="nav-item @yield('contact-active')"><a class="nav-link" href="contact.html">Contact</a></li>
                    </ul>
